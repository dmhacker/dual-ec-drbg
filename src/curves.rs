...
pub struct Curve {
    ...
    pub gx: BigInt,     // X coordinate of generator (base) point
    pub gy: BigInt      // Y coordinate of generator (base) point
}
...
impl Curve {
    pub fn gen_p256() -> Curve {
        Curve {
            ...
            gx: BigInt::parse_bytes(b"6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296", 16).unwrap(),
            gy: BigInt::parse_bytes(b"4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5", 16).unwrap()
        }
    }
    ...
    pub fn gen_p384() -> Curve {
        Curve {
            ...
            gx: BigInt::parse_bytes(b"aa87ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f741e082542a385502f25dbf55296c3a545e3872760ab7", 16).unwrap(),
            gy: BigInt::parse_bytes(b"3617de4a96262c6f5d9e98bf9292dc29f8f41dbd289a147ce9da3113b5f0b8c00a60b1ce1d7e819d7a431d7c90ea0e5f", 16).unwrap()
        }
    }
    ...
    pub fn gen_p521() -> Curve {
        Curve {
            ...
            gx: BigInt::parse_bytes(b"c6858e06b70404e9cd9e3ecb662395b4429c648139053fb521f828af606b4d3dbaa14b5e77efe75928fe1dc127a2ffa8de3348b3c1856a429bf97e7e31c2e5bd66", 16).unwrap(),
            gy: BigInt::parse_bytes(b"11839296a789a3bc0045c8a5fb42c7d1bd998f54449579b446817afbd17273e662c97ee72995ef42640c550b9013fad0761353c7086a272c24088be94769fd16650", 16).unwrap()
        }
    }
}
